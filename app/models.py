...
import pytz  # Ensure pytz is used for timezone conversion
...
class Attendance(db.Model):
    ...
    def __init__(self, employee_id, clock_in=None, clock_out=None, break_time=None, total_work_hours=None):
        ...
        self.clock_in = clock_in if clock_in else datetime.utcnow().replace(tzinfo=pytz.utc).astimezone(self.UK_TIMEZONE)
